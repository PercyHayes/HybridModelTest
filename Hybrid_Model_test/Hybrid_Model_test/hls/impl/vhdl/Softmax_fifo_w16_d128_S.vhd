...
entity Softmax_fifo_w16_d128_S is 
    generic (
...
architecture rtl of Softmax_fifo_w16_d128_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Softmax_fifo_w16_d128_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 7;
        DEPTH      : integer := 128);
...
begin
----------------------- Instantiation -----------------------
    U_Softmax_fifo_w16_d128_S_ShiftReg : Softmax_fifo_w16_d128_S_ShiftReg
    generic map (
...
entity Softmax_fifo_w16_d128_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 7;
        DEPTH      : integer := 128);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Softmax_fifo_w16_d128_S_ShiftReg;

architecture rtl of Softmax_fifo_w16_d128_S_ShiftReg is
