...
module Gemv_Test_Accumulator_Quantizer_9_Pipeline_VITIS_LOOP_17_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    adder_tree_output_3_read_local;
reg    scale_dispacher_3_read_local;
...
wire   [0:0] tmp_590_fu_252_p3;
wire   [0:0] tmp_589_fu_235_p3;
wire   [0:0] xor_ln28_fu_260_p2;
wire   [14:0] tmp_1_fu_280_p4;
wire   [15:0] tmp_3_fu_296_p4;
wire   [0:0] and_ln28_fu_266_p2;
wire   [0:0] icmp_ln28_1_fu_306_p2;
wire   [0:0] icmp_ln28_2_fu_312_p2;
wire   [0:0] tmp_591_fu_272_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0))) begin
        ...
        tmp_588_reg_465 <= mul_ln28_fu_131_p2[32'd15];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        adder_tree_output_3_read_local = 1'b1;
    end else begin
        adder_tree_output_3_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        scale_dispacher_3_read_local = 1'b1;
    end else begin
        scale_dispacher_3_read_local = 1'b0;
    end
end
...
assign adder_tree_output_3_read = adder_tree_output_3_read_local;
...
assign and_ln28_4_fu_376_p2 = (tmp_590_fu_252_p3 & select_ln28_1_fu_338_p3);

assign and_ln28_5_fu_394_p2 = (xor_ln28_4_fu_388_p2 & tmp_fu_217_p3);

assign and_ln28_fu_266_p2 = (xor_ln28_fu_260_p2 & tmp_589_fu_235_p3);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (scale_dispacher_3_empty_n == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == adder_tree_output_3_empty_n))));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == adder_tree_output_3_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp2 = ((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (scale_dispacher_3_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (scale_dispacher_3_empty_n == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == adder_tree_output_3_empty_n))));
end

assign ap_block_pp0_stage0_subdone_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp1 = ((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (1'b0 == adder_tree_output_3_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp2 = ((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (scale_dispacher_3_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign icmp_ln17_fu_158_p2 = (($signed(zext_ln17_fu_154_p1) < $signed(cols_2)) ? 1'b1 : 1'b0);

assign icmp_ln28_1_fu_306_p2 = ((tmp_3_fu_296_p4 == 16'd65535) ? 1'b1 : 1'b0);

assign icmp_ln28_2_fu_312_p2 = ((tmp_3_fu_296_p4 == 16'd0) ? 1'b1 : 1'b0);

assign icmp_ln28_fu_290_p2 = ((tmp_1_fu_280_p4 == 15'd32767) ? 1'b1 : 1'b0);

assign or_ln28_1_fu_408_p2 = (and_ln28_5_fu_394_p2 | and_ln28_3_fu_370_p2);

assign or_ln28_2_fu_382_p2 = (and_ln28_4_fu_376_p2 | and_ln28_2_fu_346_p2);

assign or_ln28_fu_358_p2 = (xor_ln28_2_fu_352_p2 | tmp_590_fu_252_p3);

assign scale_dispacher_3_read = scale_dispacher_3_read_local;
...
assign select_ln28_3_fu_414_p3 = ((or_ln28_1_fu_408_p2[0:0] == 1'b1) ? select_ln28_2_fu_400_p3 : add_ln28_1_fu_246_p2);
...
assign tmp_1_fu_280_p4 = {{add_ln28_fu_212_p2[63:49]}};

assign tmp_3_fu_296_p4 = {{add_ln28_fu_212_p2[63:48]}};

assign tmp_589_fu_235_p3 = add_ln28_fu_212_p2[32'd47];

assign tmp_590_fu_252_p3 = add_ln28_1_fu_246_p2[32'd31];

assign tmp_591_fu_272_p3 = add_ln28_fu_212_p2[32'd48];

assign tmp_fu_217_p3 = add_ln28_fu_212_p2[32'd63];

assign trunc_ln_fu_225_p4 = {{add_ln28_fu_212_p2[47:16]}};

assign xor_ln28_1_fu_326_p2 = (tmp_591_fu_272_p3 ^ 1'd1);

assign xor_ln28_2_fu_352_p2 = (select_ln28_fu_318_p3 ^ 1'd1);

assign xor_ln28_3_fu_364_p2 = (tmp_fu_217_p3 ^ 1'd1);

assign xor_ln28_4_fu_388_p2 = (or_ln28_2_fu_382_p2 ^ 1'd1);

assign xor_ln28_fu_260_p2 = (tmp_590_fu_252_p3 ^ 1'd1);

assign zext_ln17_fu_154_p1 = ap_sig_allocacmp_c_load;

assign zext_ln28_fu_243_p1 = tmp_588_reg_465;

endmodule //Gemv_Test_Accumulator_Quantizer_9_Pipeline_VITIS_LOOP_17_2
