...
entity Softmax_start_for_Loop_softmax_output_proc_U0 is 
    generic (
...
architecture rtl of Softmax_start_for_Loop_softmax_output_proc_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg : Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg
    generic map (
...
entity Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg;

architecture rtl of Softmax_start_for_Loop_softmax_output_proc_U0_ShiftReg is
