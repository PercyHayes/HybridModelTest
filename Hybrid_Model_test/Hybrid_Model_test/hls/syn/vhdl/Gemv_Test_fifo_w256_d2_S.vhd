...
entity Gemv_Test_fifo_w256_d2_S is 
    generic (
...
architecture rtl of Gemv_Test_fifo_w256_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Gemv_Test_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_Gemv_Test_fifo_w256_d2_S_ShiftReg : Gemv_Test_fifo_w256_d2_S_ShiftReg
    generic map (
...
entity Gemv_Test_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Gemv_Test_fifo_w256_d2_S_ShiftReg;

architecture rtl of Gemv_Test_fifo_w256_d2_S_ShiftReg is
