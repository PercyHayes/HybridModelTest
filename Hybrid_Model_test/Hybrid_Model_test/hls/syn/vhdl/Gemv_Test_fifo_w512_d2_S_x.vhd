...
entity Gemv_Test_fifo_w512_d2_S_x is 
    generic (
...
architecture rtl of Gemv_Test_fifo_w512_d2_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Gemv_Test_fifo_w512_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_Gemv_Test_fifo_w512_d2_S_x_ShiftReg : Gemv_Test_fifo_w512_d2_S_x_ShiftReg
    generic map (
...
entity Gemv_Test_fifo_w512_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Gemv_Test_fifo_w512_d2_S_x_ShiftReg;

architecture rtl of Gemv_Test_fifo_w512_d2_S_x_ShiftReg is
